  ...
  const varieties = [
    {
      ...
      origin: 'США, 1952',
      maturity: 'Средний',
      berrySize: 'Крупная (16-20 мм)',
      yield: '4-9 кг с куста',
      winterHardiness: 'До -34°C',
      harvest: 'Июль-август',
      taste: 'Кисло-сладкий, гармоничный',
      features: ['Высокая урожайность', 'Морозостойкость', 'Транспортабельность'],
      description: 'Один из самых популярных сортов голубики. Универсальный сорт для промышленного и любительского выращивания.',
      image: '/img/6603adcd-674a-4f7d-a83c-7a5368739fd1.jpg'
    },
    {
      id: 2,
      ...
      origin: 'США, 1976',
      maturity: 'Средний',
      berrySize: 'Очень крупная (18-22 мм)',
      yield: '5-7 кг с куста',
      winterHardiness: 'До -37°C',
      harvest: 'Июль',
      taste: 'Сладкий, десертный',
      features: ['Очень крупные ягоды', 'Устойчивость к болезням', 'Декоративность'],
      description: 'Сорт с исключительно крупными ягодами и высокой морозостойкостью. Подходит для северных регионов.',
      image: '/img/d188ad5d-9631-4fe5-86e0-f567b51fa67b.jpg'
    },
    {
      id: 3,
      ...
      winterHardiness: 'До -34°C',
      harvest: 'Июнь-июль',
      taste: 'Кисло-сладкий, ароматный',
      features: ['Ранний срок созревания', 'Дружное созревание', 'Хорошая лежкость'],
      description: 'Один из лучших ранних сортов. Плоды созревают дружно, что удобно для коммерческого выращивания.',
      image: '/img/7ce43893-70e8-4567-966d-e5a1dc8b5a02.jpg'
    },
    {
      id: 4,
      ...
      winterHardiness: 'До -32°C',
      harvest: 'Август-сентябрь',
      taste: 'Очень сладкий, винный',
      features: ['Исключительный вкус', 'Очень крупные ягоды', 'Позднее созревание'],
      description: 'Эталон вкуса среди голубики. Поздний срок созревания позволяет продлить сезон потребления свежих ягод.',
      image: '/img/1134a526-7d35-4601-bfc2-e33008f51107.jpg'
    },
    {
      id: 5,
      ...
      origin: 'США, 1990',
      maturity: 'Средний',
      berrySize: 'Крупная (16-19 мм)',
      yield: '3-5 кг с куста',
      winterHardiness: 'До -23°C',
      harvest: 'Июль',
      taste: 'Сладкий, тропический',
      features: ['Низкие требования к холоду', 'Декоративное цветение', 'Компактный куст'],
      description: 'Сорт для южных регионов с мягкими зимами. Отлично подходит для выращивания в теплом климате.',
    ...
    },
    {
      ...
      origin: 'США, 1967',
      maturity: 'Ранний',
      berrySize: 'Средняя (12-16 мм)',
      yield: '3-4 кг с куста',
      winterHardiness: 'До -40°C',
      harvest: 'Июнь-июль',
      taste: 'Кисло-сладкий, освежающий',
      features: ['Исключительная морозостойкость', 'Компактный размер', 'Раннее созревание'],
      description: 'Один из самых морозостойких сортов. Идеален для регионов с суровым климатом и коротким летом.',
